...
class _PersonalDataScreenState extends State<PersonalDataScreen> {
      ...
      if (_currentUser != null) {
        ...
        if (userDoc.exists) {
          ...
          setState(() {
            ...
            // Check if values exist in list before setting, otherwise set to null or default
            if (_educationLevels.contains(data['educationLevel'])) {
              _selectedEducationLevel = data['educationLevel'];
            }
            if (_socialStatuses.contains(data['socialStatus'])) {
              _selectedSocialStatus = data['socialStatus'];
            }
      ...
      await FirebaseFirestore.instance
          ...
          .update({
            ...
            'email': _emailController.text
                .trim(), // Normally email shouldn't be editable easily if it's the auth email
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    if (picked != null) {
      ...
      debugPrint('تاريخ الميلاد المختار: $formattedDate');
    }
  }
                  ...
                  children: [
                    if (_isLoading)
                      ...
                      _buildTextField(
                        ...
                        // Making email read-only usually better for auth consistency, but user requested registration logic
                        // readOnly: true,
                      ),
                      ...
                      _buildDateTextField(
                        label: 'تاريخ الميلاد',
                        hint: _dobController.text.isNotEmpty
                            ? _dobController.text
                            : 'اليوم / التاريخ / السنة',
  ...
  Widget _buildTextField({
    ...
    controller, // Changed from initialValue to controller
    bool readOnly = false,
  }) {
    return Padding(
